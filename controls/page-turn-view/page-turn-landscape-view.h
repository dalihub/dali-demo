#ifndef DALI_DEMO_CONTROLS_PAGE_TURN_LANDSCAPE_VIEW_H
#define DALI_DEMO_CONTROLS_PAGE_TURN_LANDSCAPE_VIEW_H
 ...
 * @SINCE_1_0.0
 */
class DALI_DEMO_CONTROLS_API PageTurnLandscapeView : public PageTurnView
{
public:
  /**
