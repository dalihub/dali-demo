#ifndef DALI_DEMO_CONTROLS_PAGE_TURN_PORTRAIT_VIEW_H
#define DALI_DEMO_CONTROLS_PAGE_TURN_PORTRAIT_VIEW_H
 ...
 * @SINCE_1_1.4
 */
class DALI_DEMO_CONTROLS_API PageTurnPortraitView : public PageTurnView
{
public:
  /**
