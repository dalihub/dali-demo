...
void PageTurnView::OnInitialize()
{
  ...
  mGeometry       = Toolkit::VisualFactory::Get().CreateGridGeometry(Uint16Pair(width, height), true);
  ...
  Self().SetProperty(DevelControl::Property::ACCESSIBILITY_ROLE, Dali::Toolkit::Accessibility::Role::TAB_LIST);
}
