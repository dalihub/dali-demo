#ifndef DALI_DEMO_CONTROLS_INTERNAL_CUBE_TRANSITION_CROSS_EFFECT_H
#define DALI_DEMO_CONTROLS_INTERNAL_CUBE_TRANSITION_CROSS_EFFECT_H
...
public:
  /**
   * @copydoc Demo::CubeTransitionCrossEffect::New
   */
  static Demo::CubeTransitionCrossEffect New(unsigned int numRows, unsigned int numColumns);
...
inline Internal::CubeTransitionCrossEffect& GetImpl(Dali::Demo::CubeTransitionCrossEffect& obj)
{
...
inline const Internal::CubeTransitionCrossEffect& GetImpl(const Dali::Demo::CubeTransitionCrossEffect& obj)
{
  DALI_ASSERT_ALWAYS(obj);
