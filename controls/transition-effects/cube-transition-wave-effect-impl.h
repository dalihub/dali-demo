#ifndef DALI_DEMO_CONTROLS_INTERNAL_CUBE_TRANSITION_WAVE_EFFECT_H
#define DALI_DEMO_CONTROLS_INTERNAL_CUBE_TRANSITION_WAVE_EFFECT_H
...
public:
  /**
   * @copydoc Demo::CubeTransitionWaveEffect::New
   */
  static Demo::CubeTransitionWaveEffect New(unsigned int numRows, unsigned int numColumns);

protected:
  /**
   * @copydoc Demo::Internal::CubeTransitionEffect::OnInitialize
   */
  void OnInitialize() override;

  /**
   * @copydoc Demo::Internal::CubeTransitionEffect::OnStartTransition
   */
...
inline Internal::CubeTransitionWaveEffect& GetImpl(Dali::Demo::CubeTransitionWaveEffect& obj)
{
...
inline const Internal::CubeTransitionWaveEffect& GetImpl(const Dali::Demo::CubeTransitionWaveEffect& obj)
{
  DALI_ASSERT_ALWAYS(obj);
