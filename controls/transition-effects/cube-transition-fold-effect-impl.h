#ifndef DALI_DEMO_CONTROLS_INTERNAL_CUBE_TRANSITION_FOLD_EFFECT_H
#define DALI_DEMO_CONTROLS_INTERNAL_CUBE_TRANSITION_FOLD_EFFECT_H
...
public:
  /**
   * @copydoc Demo::CubeTransitionFoldEffect::New
   */
  static Demo::CubeTransitionFoldEffect New(unsigned int numRows, unsigned int numColumns);
...
inline Internal::CubeTransitionFoldEffect& GetImpl(Dali::Demo::CubeTransitionFoldEffect& obj)
{
...
inline const Internal::CubeTransitionFoldEffect& GetImpl(const Dali::Demo::CubeTransitionFoldEffect& obj)
{
  DALI_ASSERT_ALWAYS(obj);
