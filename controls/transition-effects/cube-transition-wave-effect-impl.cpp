...
Demo::CubeTransitionWaveEffect CubeTransitionWaveEffect::New(unsigned int numRows, unsigned int numColumns)
{
  ...
  Demo::CubeTransitionWaveEffect cubeTransEffect(*internalCubeTransEffect);
