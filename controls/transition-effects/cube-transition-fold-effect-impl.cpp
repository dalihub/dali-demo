...
Demo::CubeTransitionFoldEffect CubeTransitionFoldEffect::New(unsigned int numRows, unsigned int numColumns)
{
  ...
  Demo::CubeTransitionFoldEffect cubeTransEffect(*internalCubeTransEffect);
