#ifndef DALI_DEMO_CONTROLS_CUBE_TRANSITION_FOLD_EFFECT_H
#define DALI_DEMO_CONTROLS_CUBE_TRANSITION_FOLD_EFFECT_H
 ...
 */
class DALI_DEMO_CONTROLS_API CubeTransitionFoldEffect : public CubeTransitionEffect
{
public:
  /**
