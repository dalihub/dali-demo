#ifndef DALI_DEMO_CONTROLS_CUBE_TRANSITION_EFFECT_H
#define DALI_DEMO_CONTROLS_CUBE_TRANSITION_EFFECT_H
 ...
 */
class DALI_DEMO_CONTROLS_API CubeTransitionEffect : public Toolkit::Control
{
public:
  /**
