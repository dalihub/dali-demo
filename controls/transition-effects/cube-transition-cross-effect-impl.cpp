...
Demo::CubeTransitionCrossEffect CubeTransitionCrossEffect::New(unsigned int numRows, unsigned int numColumns)
{
  ...
  Demo::CubeTransitionCrossEffect cubeTransEffect(*internalCubeTransEffect);
