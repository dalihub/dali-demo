#ifndef DALI_DEMO_CONTROLS_CONFIRMATION_POPUP_H
#define DALI_DEMO_CONTROLS_CONFIRMATION_POPUP_H
 ...
 */
class DALI_DEMO_CONTROLS_API ConfirmationPopup : public Popup
{
public:
  /**
...
#endif // DALI_DEMO_CONTROLS_CONFIRMATION_POPUP_H
