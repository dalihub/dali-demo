#ifndef DALI_DEMO_CONTROLS_INTERNAL_POPUP_H
#define DALI_DEMO_CONTROLS_INTERNAL_POPUP_H
 ...
 * @copydoc Demo::Popup
 */
class Popup : public Toolkit::ControlImpl
{
public:
  /**
   * Create a new Popup.
   ...
   */
  static Dali::Demo::Popup New();

public:
  /**
   * @copydoc Demo::Popup::SetPopupBackgroundImage
   */
  void SetPopupBackgroundImage(Actor image);

  /**
   * @copydoc Demo::Popup::GetPopupBackgroundImage
   */
  Actor GetPopupBackgroundImage() const;

  /**
   * @copydoc Demo::Popup::SetTitle( Actor titleActor )
   */
  void SetTitle(Actor titleActor);

  /**
   * @copydoc Demo::Popup::GetTitle
   */
  Actor GetTitle() const;

  /**
   * @copydoc Demo::Popup::SetContent
   */
  void SetContent(Actor content);

  /**
   * @copydoc Demo::Popup::GetContent
   */
  Actor GetContent() const;

  /**
   * @copydoc Demo::Popup::SetFooter
   */
  void SetFooter(Actor control);

  /**
   * @copydoc Demo::Popup::GetFooter
   */
  Actor GetFooter() const;

  /**
   * @copydoc Demo::Popup::SetDisplayState
   */
  void SetDisplayState(Demo::Popup::DisplayState displayState);

  /**
   * @copydoc Demo::Popup::GetDisplayState
   */
  Demo::Popup::DisplayState GetDisplayState() const;

  /**
   * @copydoc Demo::Popup::SetTailVisibility
   */
  void SetTailVisibility(bool visible);

  /**
   * @copydoc Demo::Popup::IsTailVisible
   */
  bool IsTailVisible() const;

  /**
   * @copydoc Demo::Popup::SetTailPosition
   */
  void SetTailPosition(Vector3 position);

  /**
   * @copydoc Demo::Popup::GetTailPosition
   */
  const Vector3& GetTailPosition() const;

  /**
   * @copydoc Demo::Popup::SetContextualMode
   */
  void SetContextualMode(Demo::Popup::ContextualMode mode);

  /**
   * @copydoc Demo::Popup::GetContextualMode
   */
  Demo::Popup::ContextualMode GetContextualMode() const;

  /**
   * @copydoc Demo::Popup::SetAnimationDuration
   */
  void SetAnimationDuration(float duration);

  /**
   * @copydoc Demo::Popup::GetAnimationDuration
   */
  float GetAnimationDuration() const;

  /**
   * @copydoc Demo::Popup::SetAnimationMode
   */
  void SetAnimationMode(Demo::Popup::AnimationMode animationMode);

  /**
   * @copydoc Demo::Popup::GetAnimationMode
   */
  Demo::Popup::AnimationMode GetAnimationMode() const;

  /**
   * @copydoc Demo::Popup::SetAutoHideDelay
   */
  void SetAutoHideDelay(int delay);

  /**
   * @copydoc Demo::Popup::GetAutoHideDelay
   */
  int GetAutoHideDelay() const;

  /**
   * @copydoc Demo::Popup::SetBackingEnabled
   */
  void SetBackingEnabled(bool enabled);

  /**
   * @copydoc Demo::Popup::IsBackingEnabled
   */
  bool IsBackingEnabled() const;

  /**
   * @copydoc Demo::Popup::SetBackingColor
   */
  void SetBackingColor(Vector4 color);

  /**
   * @copydoc Demo::Popup::GetBackingColor
   */
  const Vector4& GetBackingColor() const;

  /**
   * @copydoc Demo::Popup::SetTailUpImage
   */
  void SetTailUpImage(std::string image);

  /**
   * @copydoc Demo::Popup::GetTailUpImage
   */
  const std::string& GetTailUpImage() const;

  /**
   * @copydoc Demo::Popup::SetTailDownImage
   */
  void SetTailDownImage(std::string image);

  /**
   * @copydoc Demo::Popup::GetTailDownImage
   */
  const std::string& GetTailDownImage() const;

  /**
   * @copydoc Demo::Popup::SetTailLeftImage
   */
  void SetTailLeftImage(std::string image);

  /**
   * @copydoc Demo::Popup::GetTailLeftImage
   */
  const std::string& GetTailLeftImage() const;

  /**
   * @copydoc Demo::Popup::SetTailRightImage
   */
  void SetTailRightImage(std::string image);

  /**
   * @copydoc Demo::Popup::GetTailRightImage
   */
...
protected:
  class PopupAccessible : public Toolkit::DevelControl::ControlAccessible
  {
  public:
...
public: // Signals
  /**
   * @copydoc Dali::Demo::Popup::OutsideTouchedSignal()
   */
  Demo::Popup::TouchedOutsideSignalType& OutsideTouchedSignal();

  /**
   * @copydoc Dali::Demo::Popup::ShowingSignal()
   */
  Demo::Popup::DisplayStateChangeSignalType& ShowingSignal();

  /**
   * @copydoc Dali::Demo::Popup::ShownSignal()
   */
  Demo::Popup::DisplayStateChangeSignalType& ShownSignal();

  /**
   * @copydoc Dali::Demo::Popup::HidingSignal()
   */
  Demo::Popup::DisplayStateChangeSignalType& HidingSignal();

  /**
   * @copydoc Dali::Demo::Popup::HiddenSignal()
   */
  Demo::Popup::DisplayStateChangeSignalType& HiddenSignal();
...
private:
  Demo::Popup::TouchedOutsideSignalType     mTouchedOutsideSignal;
  Demo::Popup::DisplayStateChangeSignalType mShowingSignal;
  Demo::Popup::DisplayStateChangeSignalType mShownSignal;
  Demo::Popup::DisplayStateChangeSignalType mHidingSignal;
  Demo::Popup::DisplayStateChangeSignalType mHiddenSignal;
  ...
  Demo::Popup::DisplayState   mDisplayState;       ///< The current display state of the popup.
  bool                        mTailVisible;        ///< True if the popup tail should be visible.
  Vector3                     mTailPosition;       ///< The position of the tail.
  Demo::Popup::ContextualMode mContextualMode;     ///< Allows the popup to be layed out adjacent to its parent in different directions.
  float                       mAnimationDuration;  ///< The duration of the transition in and out animations.
  Demo::Popup::AnimationMode  mAnimationMode;      ///< The animation to use to transition in and out.
...
inline Demo::Internal::Popup& GetImpl(Demo::Popup& publicObject)
{
  DALI_ASSERT_ALWAYS(publicObject);

  Dali::RefObject& handle = publicObject.GetImplementation();

  return static_cast<Demo::Internal::Popup&>(handle);
}

inline const Demo::Internal::Popup& GetImpl(const Demo::Popup& publicObject)
{
  DALI_ASSERT_ALWAYS(publicObject);

  const Dali::RefObject& handle = publicObject.GetImplementation();

  return static_cast<const Demo::Internal::Popup&>(handle);
}

} // namespace Demo
} // namespace Dali

#endif // DALI_DEMO_CONTROLS_INTERNAL_POPUP_H
