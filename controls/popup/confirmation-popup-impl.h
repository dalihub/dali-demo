#ifndef DALI_DEMO_CONTROLS_INTERNAL_CONFIRMATION_POPUP_H
#define DALI_DEMO_CONTROLS_INTERNAL_CONFIRMATION_POPUP_H
...
// INTERNAL INCLUDES
#include <controls/popup/confirmation-popup.h>
 ...
 */
class ConfirmationPopup : public Dali::Demo::Internal::Popup
{
public:
  /**
   ...
   */
  static Dali::Demo::ConfirmationPopup New();
...
inline Demo::Internal::ConfirmationPopup& GetDerivedImplementation(Demo::ConfirmationPopup& popup)
{
  DALI_ASSERT_ALWAYS(popup);

  Dali::RefObject& handle = popup.GetImplementation();

  return static_cast<Demo::Internal::ConfirmationPopup&>(handle);
}

inline const Demo::Internal::ConfirmationPopup& GetDerivedImplementation(const Demo::ConfirmationPopup& popup)
{
  DALI_ASSERT_ALWAYS(popup);

  const Dali::RefObject& handle = popup.GetImplementation();

  return static_cast<const Demo::Internal::ConfirmationPopup&>(handle);
}

} // namespace Dali::Demo

#endif // DALI_DEMO_CONTROLS_INTERNAL_CONFIRMATION_POPUP_H
