#ifndef DALI_DEMO_CONTROLS_POPUP_H
#define DALI_DEMO_CONTROLS_POPUP_H
 ...
 */
class DALI_DEMO_CONTROLS_API Popup : public Toolkit::Control
{
public:
  /**
...
#endif // DALI_DEMO_CONTROLS_POPUP_H
