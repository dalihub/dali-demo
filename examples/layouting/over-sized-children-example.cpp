...
{
  // Create ImaegView with a DESIRED_WIDTH and DESIRED_HEIGHT
  ...
  //mContainer.SetProperty( Toolkit::LayoutItem::ChildProperty::WIDTH_SPECIFICATION, ChildLayoutData::WRAP_CONTENT ); // Doesn't wrap to image view size
 // mContainer.SetProperty( Toolkit::LayoutItem::ChildProperty::HEIGHT_SPECIFICATION, ChildLayoutData::WRAP_CONTENT ); // Doesn't wrap to image view size
