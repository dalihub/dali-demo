...
class LayoutingExample: public ConnectionTracker
{
 public:
  ...
  void Create( Application& application )
  {
    ...
    mLinearContainer.Demo::LinearContainer::Create();
  }
  ...
  bool ChangeLayout( Button button )
  {
    ...
    switch( mLayoutIndex )
    {
      case 1 :
      {
        mLinearContainer.Remove();
        mLinearContainerPadded.Create();
        break;
      }
      case 2 :
      {
        mNextLayout.SetProperty( Toolkit::Button::Property::DISABLED, true );
        mLinearContainerPadded.Remove();
        break;
      }
      default :
      {
...
private:
  ...
  Demo::LinearContainer mLinearContainer;
  Demo::LinearContainerPadded mLinearContainerPadded;
