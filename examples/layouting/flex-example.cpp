...
#include "../../../dali-toolkit/dali-toolkit/devel-api/layouting/flex-layout.h"
...
void FlexExample::Create()
{
  ...
  layout.SetFlexJustification( Toolkit::FlexLayout::JUSTIFY_FLEX_START );
  layout.SetFlexAlignment( Toolkit::FlexLayout::ALIGN_FLEX_START );
  ...
  for( unsigned int x = 0; x < NUMBER_OF_RESOURCES; ++x )
  {
    ...
    imageView.SetProperty( Toolkit::FlexLayout::ChildProperty::ALIGN_SELF, Toolkit::FlexLayout::ALIGN_CENTER );
...
bool FlexExample::OnWrapClicked( Button button )
{
  ...
  if ( layout.GetFlexWrap() == Toolkit::FlexLayout::WrapType::NO_WRAP )
  {
    ...
    layout.SetFlexAlignment( Toolkit::FlexLayout::ALIGN_CENTER );
...
{
   auto layout = FlexLayout::DownCast(DevelControl::GetLayout( mFlexContainer ));
   if ( layout.GetFlexJustification() == Toolkit::FlexLayout::JUSTIFY_FLEX_START )
   {
     layout.SetFlexJustification( Toolkit::FlexLayout::JUSTIFY_SPACE_BETWEEN);
   }
   else
   {
     layout.SetFlexJustification( Toolkit::FlexLayout::JUSTIFY_FLEX_START );
