#ifndef DALI_DEMO_LINEAR_CONTAINER_PADDED_H
#define DALI_DEMO_LINEAR_CONTAINER_PADDED_H
...
class LinearContainerPadded: public ConnectionTracker
{
public:
...
#endif // DALI_DEMO_LINEAR_CONTAINER_PADDED_H
