...
public:
  ...
  {
    mShader = Shader::New(ToDaliStringView(SHADER_RENDERING_LINE_VERT), ToDaliStringView(SHADER_RENDERING_LINE_FRAG));
  }
  ...
  void CreateActor()
  {
    ...
    mActor.SetProperty(Actor::Property::COLOR_MULTIPLIER, Color::BLACK);
