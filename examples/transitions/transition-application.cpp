...
void TransitionApplication::Create(Application application)
{
  ...
  DevelActor::SetResizePolicy(buttonLayout, ResizePolicy::FILL_TO_PARENT, Dimension::ALL_DIMENSIONS);
  ...
  DevelActor::SetResizePolicy(mShadowButton, ResizePolicy::FILL_TO_PARENT, Dimension::ALL_DIMENSIONS);
