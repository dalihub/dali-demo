...
void TransitionApplication::Create(Application& application)
{
  ...
  for(int i = 0; i < NUMBER_OF_VISUAL_BUTTONS; ++i)
  {
    ...
    map.Add(Visual::Property::TRANSFORM, Property::Map().Add(Visual::Transform::Property::SIZE, Vector2(0.8f, 0.8f)));
...
bool TransitionApplication::OnVisualButtonClicked(Actor actor, const TouchEvent& touch)
{
  if(touch.GetState(0) == PointState::FINISHED)
  {
    ...
    map.Add(Visual::Property::TRANSFORM, Property::Map().Add(Visual::Transform::Property::SIZE, Vector2(0.5f, 0.5f)));
