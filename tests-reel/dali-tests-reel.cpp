...
int DALI_EXPORT_API main(int argc, char** argv)
{
  ...
  demo.AddExample(Example("perf-message-queue-stress.example", DALI_DEMO_STR_TITLE_PERF_MESSAGE_QUEUE_STRESS));
  demo.AddExample(Example("perf-property-update.example", DALI_DEMO_STR_TITLE_PERF_PROPERTY_UPDATE));
